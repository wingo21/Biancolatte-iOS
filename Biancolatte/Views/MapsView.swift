...
let PointsOfInterest = [
        BLLocation(name: "Biancolatte Williamsburg", placemark: "109 Bedford Ave, Brooklyn, NY 11249", coordinate: CLLocationCoordinate2D(latitude: 40.72005671926065, longitude: -73.95512368052952), website: URL(string: "http://biancolatte.nyc/"), google: URL(string: "https://goo.gl/maps/77afeDDPVZNVdmov8")),
        BLLocation(name: "Biancolatte Hudson Yards", placemark: "20 Hudson Yards c/o Ana Bar and Eatery, New York, NY 10001", coordinate: CLLocationCoordinate2D(latitude: 40.75349031717275, longitude: -74.00100907329055), website: URL(string: "http://biancolatte.nyc/"), google: URL(string: "https://goo.gl/maps/stiJEtbLRFUXPnCt9"))
]
