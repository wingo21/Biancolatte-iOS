...
let PointsOfInterest = [
        BLLocation(name: "Biancolatte Williamsburg", placemark: "109 Bedford Ave, Brooklyn, NY 11249", coordinate: CLLocationCoordinate2D(latitude: 40.72005671926065, longitude: -73.95512368052952), website: URL(string: "http://biancolatte.nyc/"), google: URL(string: "https://goo.gl/maps/77afeDDPVZNVdmov8"), locationImage: Image("Williamsburg")),
